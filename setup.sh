...
cp -r .bashrc ~/
ame -Sy
ame install crystal-core crystal-branding spotify-launcher steam wqy-zenhei heroic-games-launcher lutris bitwarden kitty rustup gcc cmake make pkg-config ttf-firacode-nerd neovim wget
